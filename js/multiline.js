...
//Create axis
    chartObj.xAxis = d3.axisBottom(chartObj.xScale).tickFormat(function(d){ return d;});
    // chartObj.xAxis = d3.svg.axis().scale(chartObj.xScale)
    
    chartObj.xAxis
        // .orient("bottom").tickFormat(chartObj.xFormatter); //< Can be overridden in definition
    console.log(chartObj)
    ...
    chartObj.yAxis = d3.axisLeft(chartObj.yScale).tickFormat(function(d){ return d;});
    console.log(chartObj)
...
// Build line building functions
    ...
    for (var yObj in yObjs) {
        //change d3.svg.line().interpolate("cardinal").x(function (d)
